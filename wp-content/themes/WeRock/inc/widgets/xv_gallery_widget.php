...
class xv_gallery_widget extends WP_Widget
{
  function xv_gallery_widget()
  {
    $widget_ops = array('classname' => 'xv_gallery_widget', 'description' => 'Display latest posts with thumbnails' );
    $this->WP_Widget('xv_gallery_widget', 'WeRock Gallery', $widget_ops);
  }
...
<?php
  ...
  {  
    ...
    if(function_exists(get_werock_gallery_widget)){
       get_werock_gallery_widget($title,$post_per_page,$offset);
    }else{
   ...
   echo $after_widget;
    ...
    add_action( 'widgets_init', create_function('', 'return register_widget("xv_gallery_widget");') );
