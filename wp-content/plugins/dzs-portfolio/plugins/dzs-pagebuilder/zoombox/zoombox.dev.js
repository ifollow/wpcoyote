...
//                    console.log(_cach, _t, _cach==_t);
        ...
        function gotoItem(arg, argtype, otherargs) {
            ...
            var defaults = {
                type: 'image', video_sourceogg: '', video_title: '', video_type: 'normal', video_previewimg: '', video_width: '598', video_height: '300', video_description: '', extra_classes: '', forcenodeeplink: "off", title: '', animation_for_pastHolder_goForward: false
            };
...
//            console.info(iw, ih);
            ...
            if(o.design_skin=='skin-nebula' && _theDivItem){
                _conHolder.find('.holder-text').width(iw);
                _theDivItem.css({
                    'height' : ih-32-(_conHolder.find('.holder-text').eq(0).outerHeight())
                })
                _conHolder.find('.holder-text').css({
                    'width' : 'auto'
                });
            }
